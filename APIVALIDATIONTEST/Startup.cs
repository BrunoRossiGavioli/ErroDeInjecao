...
namespace APIVALIDATIONTEST
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<APIVALIDATIONTESTContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("APIVALIDATIONTESTContext")));
